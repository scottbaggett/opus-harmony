...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full bg-[#0f0e11] overflow-hidden text-[#e5e5e5] select-none font-serif">
      ...
      {/* --- HUD (Playing) --- */}
      <div className={`absolute top-0 left-0 w-full p-8 flex justify-between items-start pointer-events-none transition-opacity duration-500 ${gameState === GameState.PLAYING ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="text-right space-y-1">
            ...
            <div className={`text-sm font-bold tracking-widest uppercase ${streak > 10 ? 'text-yellow-400 animate-pulse' : 'text-purple-300'}`}>
            ...
            {gameMode === 'rhythm' ? (
              ...
              <div className="text-xs text-gray-400 uppercase tracking-widest">
                {level === 1 ? 'Level 1: The Lines (E, G, B)' : 'Level 2: All Notes'}
              </div>
            )}
          </div>
      </div>
          ...
          <div className="max-w-3xl text-center space-y-8">
            ...
            <div className="flex gap-6">
              ...
              >
                ...
                <div className="relative text-center">
                  ...
                  <div className="text-xs text-gray-500 mt-1 uppercase tracking-widest">Learn to Read</div>
                </div>
              </button>
              ...
              >
                ...
                <div className="relative text-center">
                  ...
                  <div className="text-xs text-gray-500 mt-1 uppercase tracking-widest">Test Your Speed</div>
                </div>
              </button>
            </div>
            ...
            <div className="pt-12 flex items-center justify-center gap-8 text-gray-500 text-sm uppercase tracking-widest">
                <div className="flex items-center gap-2">
                    <span className="border border-white/20 w-8 h-8 flex items-center justify-center rounded">↑</span>
                    <span>Ascend</span>
                </div>
                 <div className="flex items-center gap-2">
                    <span className="border border-white/20 w-8 h-8 flex items-center justify-center rounded">↓</span>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/85 backdrop-blur-md z-30">
           <div className="max-w-xl w-full text-center p-10 border border-white/10 rounded-[3rem] bg-[#17161b] shadow-2xl transform transition-all hover:border-purple-500/30">
              <div className="mb-8">
                ...
                <p className="text-gray-500 uppercase tracking-widest text-xs">The movement has concluded</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 border-y border-white/5 py-8 mb-8">
                ...
                <div className="text-center">
                  <div className="text-xs text-gray-500 uppercase tracking-widest mb-1">High Score</div>
                  <div className="text-4xl font-serif text-amber-400 drop-shadow-[0_0_10px_rgba(251,191,36,0.3)]">{highScore.toLocaleString()}</div>
                </div>
              </div>
                ...
                {loadingAdvice ? (
                  <div className="flex items-center justify-center h-full text-gray-500 italic animate-pulse">
                   ...
                   <div className="space-y-3 relative z-10">
                      ...
                      <p className="text-gray-300 leading-relaxed text-lg font-light">"{advice.explanation}"</p>
